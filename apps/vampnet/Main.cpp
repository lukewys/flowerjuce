...
class VampNetApplication : public juce::JUCEApplication
{
public:
    VampNetApplication() {}

    const juce::String getApplicationName() override { return "VampNet Tape Looper"; }
    ...
    void initialise(const juce::String& commandLine) override
    {
        ...
        
        {
            ...
            dialogOptions.dialogTitle = "VampNet Tape Looper Setup";
    ...
    public:
                            ...
                            DocumentWindow::allButtons)
        {
            ...
            // Create VampNet frontend component
            ...
            auto& deviceManager = vampNetComponent->getLooperEngine().get_audio_device_manager();
            ...
            vampNetComponent->getLooperEngine().start_audio();
            
            setContentOwned(vampNetComponent, true);

            #if JUCE_IOS || JUCE_ANDROID
            setFullScreen(true);
            #else
            setResizable(false, false); // Fixed window size
            centreWithSize(vampNetComponent->getWidth(), vampNetComponent->getHeight());
            #endif
...
START_JUCE_APPLICATION(VampNetApplication)
