...
class WhAMApplication : public juce::JUCEApplication
{
public:
    WhAMApplication() {}

    const juce::String getApplicationName() override { return "WhAM Tape Looper"; }
    ...
    void initialise(const juce::String& commandLine) override
    {
        ...
        
        {
            ...
            dialogOptions.dialogTitle = "WhAM Tape Looper Setup";
    ...
    public:
                            ...
                            DocumentWindow::allButtons)
        {
            ...
            // Create WhAM frontend component
            ...
            centreWithSize(whamComponent->getWidth(), whamComponent->getHeight());
            #endif
...
START_JUCE_APPLICATION(WhAMApplication)
