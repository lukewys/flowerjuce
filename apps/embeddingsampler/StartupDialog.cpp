...
StartupDialog::StartupDialog(juce::AudioDeviceManager& deviceManager)
    : audioDeviceManager(deviceManager),
      titleLabel("Title", "embedding space sampler setup"),
      ...
      featureTypeLabel("Feature Type", "feature extraction method"),
      ...
      okButton("ok")
{
    ...
    featureTypeCombo.addItem("CLAP Embeddings", 1);
    featureTypeCombo.addItem("STFT Features", 2);
    featureTypeCombo.setSelectedId(1); // Default to CLAP
    featureTypeCombo.onChange = [this]() {};
    addAndMakeVisible(featureTypeCombo);
    addAndMakeVisible(featureTypeLabel);
...
void StartupDialog::resized()
{
    ...
    auto featureTypeArea = bounds.removeFromTop(40);
    featureTypeLabel.setBounds(featureTypeArea.removeFromLeft(150));
    featureTypeArea.removeFromLeft(10);
    featureTypeCombo.setBounds(featureTypeArea.removeFromLeft(200));
    bounds.removeFromTop(20);
