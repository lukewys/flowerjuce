...
public:
    ...
    void set_loop_end(size_t loop_end) { m_loop_end.store(loop_end); }
    size_t get_loop_end() const { return m_loop_end.load(); }
...
private:
    ...
    std::atomic<size_t> m_loop_end{0}; // Wrap position / end of loop
